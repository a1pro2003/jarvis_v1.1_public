...
spotifyOAuth = spotipy.SpotifyOAuth(client_id='2b83165d19de470fb185e1b6a889b566',
                                    client_secret='8282cf3ddc7646249d368ef9d3023ab5',
                                    redirect_uri='http://localhost/',
                                    scope='user-read-private user-read-playback-state user-modify-playback-state')
# scope = 'playlist-modify-public'
# OAuth = spotipy.SpotifyOAuth(scope=scope,
...
access_token = 'OofKWO0-7bJkUCuIoK3mQO506pwPwnjq1MMtWFKl9aKiRzzuQb9Ix4XKD5Tujbz_'
